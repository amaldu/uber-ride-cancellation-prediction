...
from scipy.stats import chi2_contingency, fisher_exact  # type: ignore[import-untyped]

try:
    from IPython.display import display as _display
except ImportError:
    _display = print  # type: ignore[assignment]
...
def nominal_vs_binary(df, feature_col, target_col, labels,
    ...
    noteworthy = std_res_df[std_res_df[target_pos_label].abs() > 2]
    if len(noteworthy):
